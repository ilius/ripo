...
// BodyTo mocks base method
func (m *MockExtendedRequest) BodyTo(model interface{}) error {
	ret := m.ctrl.Call(m, "BodyTo", model)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// BodyTo indicates an expected call of BodyTo
func (mr *MockExtendedRequestMockRecorder) BodyTo(model interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BodyTo", reflect.TypeOf((*MockExtendedRequest)(nil).BodyTo), model)
}
...
// Cookie mocks base method
func (m *MockExtendedRequest) Cookie(name string) (*http.Cookie, error) {
	ret := m.ctrl.Call(m, "Cookie", name)
	ret0, _ := ret[0].(*http.Cookie)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// Cookie indicates an expected call of Cookie
func (mr *MockExtendedRequestMockRecorder) Cookie(name interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Cookie", reflect.TypeOf((*MockExtendedRequest)(nil).Cookie), name)
}
...
// GetString mocks base method
func (m *MockExtendedRequest) GetString(key string, sources ...FromX) (*string, error) {
	varargs := []interface{}{key}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetString indicates an expected call of GetString
func (mr *MockExtendedRequestMockRecorder) GetString(key interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key}, sources...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetString", reflect.TypeOf((*MockExtendedRequest)(nil).GetString), varargs...)
}

// GetStringList mocks base method
func (m *MockExtendedRequest) GetStringList(key string, sources ...FromX) ([]string, error) {
	varargs := []interface{}{key}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetStringList indicates an expected call of GetStringList
func (mr *MockExtendedRequestMockRecorder) GetStringList(key interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key}, sources...)
...
// GetInt mocks base method
func (m *MockExtendedRequest) GetInt(key string, sources ...FromX) (*int, error) {
	varargs := []interface{}{key}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetInt indicates an expected call of GetInt
func (mr *MockExtendedRequestMockRecorder) GetInt(key interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key}, sources...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetInt", reflect.TypeOf((*MockExtendedRequest)(nil).GetInt), varargs...)
}

// GetIntDefault mocks base method
func (m *MockExtendedRequest) GetIntDefault(key string, defaultValue int, sources ...FromX) (int, error) {
	varargs := []interface{}{key, defaultValue}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetIntDefault indicates an expected call of GetIntDefault
func (mr *MockExtendedRequestMockRecorder) GetIntDefault(key, defaultValue interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key, defaultValue}, sources...)
...
// GetFloat mocks base method
func (m *MockExtendedRequest) GetFloat(key string, sources ...FromX) (*float64, error) {
	varargs := []interface{}{key}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetFloat indicates an expected call of GetFloat
func (mr *MockExtendedRequestMockRecorder) GetFloat(key interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key}, sources...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFloat", reflect.TypeOf((*MockExtendedRequest)(nil).GetFloat), varargs...)
}

// GetBool mocks base method
func (m *MockExtendedRequest) GetBool(key string, sources ...FromX) (*bool, error) {
	varargs := []interface{}{key}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetBool indicates an expected call of GetBool
func (mr *MockExtendedRequestMockRecorder) GetBool(key interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key}, sources...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBool", reflect.TypeOf((*MockExtendedRequest)(nil).GetBool), varargs...)
}

// GetTime mocks base method
func (m *MockExtendedRequest) GetTime(key string, sources ...FromX) (*time.Time, error) {
	varargs := []interface{}{key}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetTime indicates an expected call of GetTime
func (mr *MockExtendedRequestMockRecorder) GetTime(key interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key}, sources...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTime", reflect.TypeOf((*MockExtendedRequest)(nil).GetTime), varargs...)
}

// GetObject mocks base method
func (m *MockExtendedRequest) GetObject(key string, _type reflect.Type, sources ...FromX) (interface{}, error) {
	varargs := []interface{}{key, _type}
	for _, a := range sources {
		varargs = append(varargs, a)
	}
...
// GetObject indicates an expected call of GetObject
func (mr *MockExtendedRequestMockRecorder) GetObject(key, _type interface{}, sources ...interface{}) *gomock.Call {
	varargs := append([]interface{}{key, _type}, sources...)
...
func (m *MockExtendedRequest) GetFormValue(key string) string {
...
func (mr *MockExtendedRequestMockRecorder) GetFormValue(key interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFormValue", reflect.TypeOf((*MockExtendedRequest)(nil).GetFormValue), key)
}
